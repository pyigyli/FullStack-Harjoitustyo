...
class Stable extends React.Component<Props & WithStyles<typeof styles>, State> {
  public state = {
    selectedTroopType: 'Donkey Rider',
    ...
    return (
      <div>
        <div style={{marginBottom: '20px'}}>
          ...
          >
            <MenuItem value={'Donkey Rider'}>Donkey Rider</MenuItem>
            <MenuItem value={'Jouster'}>Jouster</MenuItem>
